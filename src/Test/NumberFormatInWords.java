...
public class NumberFormatInWords {
	...
	public static String wordFormat(int num) {
		...
		if (num<10000) {
			return wordFormat(num/10000)+ "thousand"+ ((num%10000==0)?" ":" ")+wordFormat(num%10000);
		}
		if(num<100000) {
		return wordFormat(num/100000)+ "lakh"+ ((num%100000==0)?"":"")+wordFormat(num%100000);
		}
		return wordFormat(num/100000)+"crore"+ ((num%100000==0)?"":"")+wordFormat(num%100000);
	}
